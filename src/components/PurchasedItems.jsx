                ...
                <table className="border-l border-r border-[#c8cbcf] w-full mb-4 text-[#212529] border-collapse">
                    <thead>
                        <tr className="table-secondary">
                            <td className="align-middle text-center border-t-0 border-b border-[#c8cbcf] whitespace-nowrap border-[#b3b7bb] p-3 bg-[#d6d8db]">Sl No</td>
                            ...
                            <td className="align-middle text-center border-t-0 border-b border-[#c8cbcf] whitespace-nowrap border-[#b3b7bb] p-3 bg-[#d6d8db]">Each Price</td>
                            ...
                            <td className="align-middle text-center border-t-0 border-b border-[#c8cbcf] whitespace-nowrap border-[#b3b7bb] p-3 bg-[#d6d8db]">Net Price</td>
                    ...
                    <tbody>
                        {
                            products.map(item => {
                                return (
                                    <tr key={item.id}>
                                        <td className="align-middle text-center border-t-0 border-b border-[#c8cbcf] whitespace-nowrap border-[#b3b7bb] p-3">1</td>
                                        ...
                                        <td className="align-middle text-center border-t-0 border-b border-[#c8cbcf] whitespace-nowrap border-[#b3b7bb] p-3">600</td>
